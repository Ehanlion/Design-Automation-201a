...
rm -f ./output/part2_latest_run.txt ./output/part2_td_latest_run.txt ./output/part2_notd_latest_run.txt 2>/dev/null || true
rm -f ./*part2*.log ./*part2*.log.* ./output/innovus_part2_* 2>/dev/null || true

# Generated results staging area.
