...
#*                                                  */
#* Usage: ./scripts/run3A.sh [tcl_file]            */
#*        or: bash scripts/run3A.sh                */
#**************************************************/
...
echo "Running Genus synthesis for Problem 3A (this may take a few minutes)..."
echo ""
...
if [ $GENUS_EXIT_CODE -eq 0 ]; then
    echo ""
    echo "========================================"
    echo "  Problem 3A synthesis completed successfully!"
    echo "========================================"
    echo ""
