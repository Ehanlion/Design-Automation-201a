...
Created `import_design.sh` to automate the entire import process:

```bash
#!/bin/bash
# EE 201A Lab 1 - Problem 1
# Script to import LEF/DEF/Verilog design into OpenAccess database

echo "=========================================="
echo "Starting OpenAccess Design Import"
echo "=========================================="
...
echo ""
echo "Step 0: Cleaning up existing libraries..."
rm -rf DesignLib
rm -rf NangateLib
rm -rf lib.defs
...
echo ""
echo "Step 1: Importing LEF file to create reference library..."
...
echo ""
echo "Step 2: Importing Verilog netlist..."
...
echo ""
echo "Step 3: Importing DEF file to add physical layout..."
