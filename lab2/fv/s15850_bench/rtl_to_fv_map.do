...
# Generated on: Sat Jan 31 15:52:48 PST 2026 (Sat Jan 31 23:52:48 UTC 2026)
...
set logfile fv/s15850_bench/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/s15850_bench -revised fv_map
...
set env(CDN_SYNTH_ROOT) "/w/apps4/Cadence/GENUS211/tools"
set CDN_SYNTH_ROOT      "/w/apps4/Cadence/GENUS211/tools"
set env(CW_DIR) "/w/apps4/Cadence/GENUS211/tools/lib/chipware"
set CW_DIR      "/w/apps4/Cadence/GENUS211/tools/lib/chipware"
set lec_version_required "21.20249"
if { ($lec_version < $lec_version_required) &&
    [file exists /w/apps4/Cadence/GENUS211/tools/lib/chipware/old_encrypt_sim]} {
    set env(CW_DIR_SIM) "/w/apps4/Cadence/GENUS211/tools/lib/chipware/old_encrypt_sim"
    set CW_DIR_SIM      "/w/apps4/Cadence/GENUS211/tools/lib/chipware/old_encrypt_sim"
} else {
    set env(CW_DIR_SIM) "/w/apps4/Cadence/GENUS211/tools/lib/chipware/sim"
    set CW_DIR_SIM      "/w/apps4/Cadence/GENUS211/tools/lib/chipware/sim"
}
...
read_library -liberty -both \
    /w/home.19/ee/ugrad/palatics/ee201a/lab2/NangateOpenCellLibrary_typical.lib
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -verilog2k s15850.v
elaborate_design -golden -root {s15850_bench} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/s15850_bench/fv_map.v.gz
elaborate_design -revised -root {s15850_bench}
...
#add_name_alias fv/s15850_bench/fv_map.singlebit.original_name.alias.json.gz -revised
...
set_system_mode lec
write_compared_points noneq.compared_points.s15850_bench.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.s15850_bench.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.s15850_bench.rtl.fv_map.rpt
