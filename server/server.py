#!/usr/bin/env python3
"""
Simple HTTP server for previewing files
Serves files from the ee201a directory on localhost:8000
"""
...
PORT = 8000
# Serve from parent directory (ee201a root) where all files are located
...
def start_server():
	...
	try:
		...
		print(f"Open http://localhost:{PORT}/ in your browser to view all files", flush=True)
